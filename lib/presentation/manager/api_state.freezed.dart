...
abstract class Initial<T> implements ApiState<T> {
...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$ApiStateCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'ApiState<$T>.failure(networkExceptions: $networkExceptions)';
  }
...
abstract class Failure<T> implements ApiState<T> {
